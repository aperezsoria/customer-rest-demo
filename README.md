# Customer OpenAPI Specification
[![Build Status](https://travis-ci.org/aperezsoria/customer-rest-demo.svg?branch=master)](https://travis-ci.org/aperezsoria/customer-rest-demo)
...
6. If you did everything correct, https://aperezsoria.github.io/customer-rest-demo/ will lead to your new docs
...
- Documentation(ReDoc): https://aperezsoria.github.io/customer-rest-demo/
- SwaggerUI: https://aperezsoria.github.io/customer-rest-demo/swagger-ui/
- Look full spec:
    + JSON https://aperezsoria.github.io/customer-rest-demo/swagger.json
    + YAML https://aperezsoria.github.io/customer-rest-demo/swagger.yaml
- Preview spec version for branch `[branch]`: https://aperezsoria.github.io/customer-rest-demo/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://aperezsoria.github.io/customer-rest-demo/ with url from the message: `Server started <url>`
